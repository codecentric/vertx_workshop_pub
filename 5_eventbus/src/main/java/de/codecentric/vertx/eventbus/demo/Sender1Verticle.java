 ...
 */
public class Sender1Verticle extends AbstractVerticle{
    @Override
    public void start() throws Exception {
        vertx.setPeriodic(200, delay -> vertx.eventBus()
                .send(ADDRESS_COUNTER, "wuhu", new DeliveryOptions().addHeader(HEADER, "1")));
    }
}
